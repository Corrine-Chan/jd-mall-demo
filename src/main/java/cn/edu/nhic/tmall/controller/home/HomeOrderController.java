...
import cn.edu.nhic.tmall.entity.*;
...
public class HomeOrderController extends BaseController {
    ...
    public String goToPage(HttpSession session, Map<String, Object> map,
        ...
        logger.info("转到前台京东-订单列表页");
        return "home/orderListPage";
    }
    ...
    public String goToOrderConfirmPage(@PathVariable("product_id") Integer product_id,
        ...
        logger.info("转到前台京东-订单建立页");
        return "home/productBuyPage";
    }
    ...
    public String goToOrderPayPage(Map<String, Object> map, HttpSession session,
        ...
        logger.info("转到前台京东-订单支付页");
        return "home/productPayPage";
    }
    ...
    public String goToOrderPaySuccessPage(Map<String, Object> map, HttpSession session,
        ...
        logger.info("转到前台京东-订单支付成功页");
        return "home/productPaySuccessPage";
    }
    ...
    public String goToOrderConfirmPage(Map<String, Object> map, HttpSession session,
        ...
        logger.info("转到前台京东-订单确认页");
        return "home/orderConfirmPage";
    }
    ...
    public String goToOrderSuccessPage(Map<String, Object> map, HttpSession session,
        ...
        logger.info("转到前台京东-订单完成页");
        return "home/orderSuccessPage";
    }
    ...
    public String goToCartPage(Map<String, Object> map, HttpSession session) {
        ...
        logger.info("转到前台京东-购物车页");
        return "home/productBuyCarPage";
    }
