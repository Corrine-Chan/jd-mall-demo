...
<head>
    <script src="${pageContext.request.contextPath}/res/js/home/home_productBuy.js"></script>
    <link href="${pageContext.request.contextPath}/res/css/home/home_productBuyPage.css" rel="stylesheet"/>
    <title>确认订单 - Tmall.com京东-理想生活上京东</title>
    <script>
        $(function () {
            ...
            <c:forEach items="${requestScope.orderItemList}" var="orderItem" varStatus="i">
                <tr class="tr_shop">
                    <td><span class="span_shopTitle">店铺：</span><span
                            class="span_shopName">京东${orderItem.productOrderItem_product.product_category.category_name}旗舰店</span>
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>
