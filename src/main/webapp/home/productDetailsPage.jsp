...
<head>
    <script src="${pageContext.request.contextPath}/res/js/home/home_login.js"></script>
    <script src="${pageContext.request.contextPath}/res/js/home/home_productDetails.js"></script>
    <link href="${pageContext.request.contextPath}/res/css/home/home_productDetails.css" rel="stylesheet">
    <title>${requestScope.product.product_name}-tmall.com京东</title>
</head>
<body>
<nav>
    ...
    <div class="header">
        <a href="${pageContext.request.contextPath}"><img
                src="${pageContext.request.contextPath}/res/images/home/WebsiteImage/tmallLogoB.png"></a>
        <span class="shopNameHeader">京东${requestScope.product.product_category.category_name}官方旗舰店</span>
        <input id="tid" type="hidden" value="${requestScope.product.product_category.category_id}"/>
        <img src="${pageContext.request.contextPath}/res/images/home/WebsiteImage/detailsHeaderA.png"
             class="shopAssessHeader">
        <div class="shopSearchHeader">
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="shopSearchInput">
                    <input type="text" class="searchInput" name="product_name" placeholder="搜索 京东 商品/品牌/店铺"
                           maxlength="50">
                    <input type="submit" value="搜京东" class="searchTmall">
                </div>
...
<div class="loginDiv">
    ...
    <div class="loginMessage">
        <div class="loginMessageMain">
            ...
            <img src="${pageContext.request.contextPath}/res/images/home/WebsiteImage/scan-safe.png"/><span>扫码登录更安全</span>
        </div>
    </div>
    <div class="pwdLogin">
        ...
        <form method="post" class="loginForm">
            <div class="loginInputDiv">
                <label for="name" class="loginLabel"><img
                        src="${pageContext.request.contextPath}/res/images/home/WebsiteImage/2024-04-27_235518.png"
            ...
            <div class="loginInputDiv">
                <label for="password" class="loginLabel"><img
                        src="${pageContext.request.contextPath}/res/images/home/WebsiteImage/2024-04-27_235533.png"
    ...
    <div class="qrcodeLogin">
        ...
        <div class="qrcodeMain">
            <img src="${pageContext.request.contextPath}/res/images/home/WebsiteImage/login_qrcode.png"
                 id="qrcodeA"/>
            <img src="${pageContext.request.contextPath}/res/images/home/WebsiteImage/login_qrcodeB.png"
                 id="qrcodeB"/>
        </div>
        <div class="qrcodeFooter">
            <img src="${pageContext.request.contextPath}/res/images/home/WebsiteImage/scan_icon2.png">
            <p>打开 <a href="https://www.tmall.com/wow/portal/act/app-download">手机京东</a> | <a
                    href="https://www.taobao.com/m">手机京东</a>扫一扫登录</p>
        </div>
        <div class="loginLinks">
    ...
    <div class="context_info">
        ...
        <div class="context_info_main">
            <div class="context_info_main_ad">
                <img src="${pageContext.request.contextPath}/res/images/home/WebsiteImage/context_ad.png">
                <span>全京东实物商品通用</span>
                <a href="#">去刮券<img
                        src="${pageContext.request.contextPath}/res/images/home/WebsiteImage/tmallItemContentB.png"></a>
            </div>
        ...
        <ul class="context_other_panel">
            ...
            <li class="tmall_points">送京东积分<span><fmt:formatNumber type="number"
        ...
        <dl class="context_info_member">
            ...
            <dd>
                ...
                <span class="amount-btn">
                    <img src="${pageContext.request.contextPath}/res/images/home/WebsiteImage/up.png"
                         class="amount_value_up">
                    <img src="${pageContext.request.contextPath}/res/images/home/WebsiteImage/down.png"
