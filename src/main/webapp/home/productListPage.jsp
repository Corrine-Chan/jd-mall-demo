...
<script src="${pageContext.request.contextPath}/res/js/home/home_productList.js"></script>
<link href="${pageContext.request.contextPath}/res/css/home/home_productList.css" rel="stylesheet">
<body>
<title><c:choose><c:when test="${requestScope.searchValue != null}">${requestScope.searchValue}</c:when>
    <c:otherwise><c:choose><c:when
            test="${requestScope.productList != null && fn:length(requestScope.productList)>0}">${requestScope.productList[0].product_category.category_name}</c:when><c:otherwise>没找到相关商品</c:otherwise></c:choose></c:otherwise></c:choose>-京东Tmall.com-理想生活上京东</title>
<nav>
    <%@ include file="include/navigator.jsp" %>
    <div class="header">
        <div id="mallLogo">
            <a href="${pageContext.request.contextPath}"><img
                    src="${pageContext.request.contextPath}/res/images/home/WebsiteImage/tmallLogoA.png"></a>
        </div>
...
<div class="context">
    <c:choose>
                ...
                <c:forEach items="${requestScope.productList}" var="product">
                    <div class="context_productStyle">
                        <div class="context_product">
                            ...
                            <p class="context_product_shop"><span>京东${product.product_category.category_name}旗舰店</span>
                            </p>
                            <p class="context_product_status">
                                ...
                                <span class="status_right"><img
                                        src="${pageContext.request.contextPath}/res/images/home/WebsiteImage/avatar.png"/></span>
                            </p>
                        </div>
                    </div>
                </c:forEach>
        ...
        <c:otherwise>
            <div class="error">
                <h2>亲~没找到与“${requestScope.searchValue}”相关的 商品 哦，要不您换个关键词我帮您再找找看</h2>
                <h3>建议您：</h3>
                <ol>
                    <li>看看输入的文字是否有误</li>
