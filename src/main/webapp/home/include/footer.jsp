...
<link rel="stylesheet" href="${pageContext.request.contextPath}/res/css/home/home_foot.css"/>
<div class="footer-copyright">
    <div class="footer">
        <p>
            <a href="http://pages.tmall.com/wow/seller/act/zhaoshangproduce" target="_blank">关于京东</a>
        ...
        <p class="footertwo">
            <a href="http://www.jd.com/cn/global/home" target="_blank">京东集团</a>
            <a href="http://www.jd.com" target="_blank">www.jd.com</a>
            <a href="http://www.tmall.com/" target="_blank">京东</a>
            <a href="http://www.globaljd.com/" target="_blank">全球购</a>
            <a href="https://www.alipay.com" target="_blank">支付宝</a>
        </p>
        <div class="copyright">
            增值电信业务经营许可证：
            <a href="http://www.miibeian.gov.cn/state/outPortal/loginPortal.action" target="_blank">20250103</a>
            网络文化经营许可证：
            <a href="http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/toDetail/CB964ABC7B904B7BA3472DDF700A2D6D"
               target="_blank">京网文[2024]0103号</a>
            <a href="http://jb.ccm.gov.cn/" target="_blank">12318举报</a>
            <br/>
            互联网药品信息服务资质证书编号：
            <a href="http://img.alicdn.com/tps/TB1vi6vPVXXXXbVXVXXXXXXXXXX-927-653.png"
               target="_blank">京-（经营性）-2024-0103</a>
            <a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=33010002000120" target="_blank">
                <img src="${pageContext.request.contextPath}/res/images/home/WebsiteImage/TB1yEqRPXXXXXXPXpXXXXXXXXXX-20-20.png">
                京公网安备 11000002000088号
            </a>
            <br/>
            <span style="font-weight: bold;">© 2024 网工3班web期末作业</span>
        </div>
    </div>
</div>