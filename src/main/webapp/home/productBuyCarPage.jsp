...
<head>
    <script src="${pageContext.request.contextPath}/res/js/home/home_productBuyCar.js"></script>
    <link href="${pageContext.request.contextPath}/res/css/home/home_productBuyCarPage.css" rel="stylesheet"/>
    <title>Tmall.com京东 - 购物车</title>
    <script>
        $(function () {
    ...
    <div class="header">
        <div id="mallLogo">
            <a href="${pageContext.request.contextPath}"><img
                    src="${pageContext.request.contextPath}/res/images/home/WebsiteImage/tmallLogoA.png"><span
                ...
                <c:forEach items="${requestScope.orderItemList}" var="orderItem">
                    <tr class="orderItem_category">
                        <td colspan="6"><span class="shop_logo"></span><span
                                class="category_shop">店铺：京东${orderItem.productOrderItem_product.product_category.category_name}旗舰店</span>
                        </td>
                    </tr>
