...
<head>
    <link href="${pageContext.request.contextPath}/res/css/home/home_orderConfirmPage.css" rel="stylesheet"/>
    <title>确认收货 - Tmall.com京东-理想生活上京东</title>
    <script>
...
<div class="content">
    ...
    <div class="order_info">
        ...
        <table class="table_order_orderItem">
            ...
            <tbody>
            <c:homeach items="${requestScope.productOrder.productOrderItemList}" var="orderItem" varStatus="i">
            ...
            <tr>
                <td colspan="4">
                    ...
                    <span class="info_value">京东模拟旗舰店</span>
                </td>
            </tr>
            <tr>
                <td colspan="4">
