...
<head>
    <link href="${pageContext.request.contextPath}/res/css/home/home_orderSuccessPage.css" rel="stylesheet"/>
    <title>交易成功 - Tmall.com京东-理想生活上京东</title>
</head>
<body>
<nav>
            ...
            <c:if test="${requestScope.product != null}">
                <div class="successInfo">
                    <ul class="info-rate-coin">
                        <li>
                            <span class="review_msg">认真填写商品评价，就有机会获得20点京东达人经验值！</span>
                            <a class="J_makePoint"
