...
<head>
    <script src="${pageContext.request.contextPath}/res/js/home/home_register.js"></script>
    <link href="${pageContext.request.contextPath}/res/css/home/home_register.css" rel="stylesheet">
    <title>京东tmall.com - 网上注册</title>
    <script>
        $(function () {
